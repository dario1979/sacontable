...
class RolesModel extends Model
{
    ...
    public function getRolesById($idrol){

        $query = "select idrol, descripcion as rol from roles where idrol = :pidrol order by descripcion asc";
        $pdo = DB::connection()->getPdo();
        $result = $pdo->prepare($query);
        $result->bindValue(":pidrol", $idrol);
