...
Route::post('/roles.actualizarRol', [RolesController::class, 'actualizarRol'])->name('roles.actualizarRol');
...
Route::post('/asientos.totalAsientos', [AsientosController::class, 'totalAsientos'])->name('asientos.totalAsientos');
...
Route::post('/cuentas.totalCuentas', [CuentasController::class, 'totalCuentas'])->name('cuentas.totalCuentas');
