        ...
        $(document).ready(function($) {
            ...
            flatpickr("#fecha_inicio", {
                ...
                onChange: function(selectedDates, dateStr, instance) {
                    ...
                    if (fechaFin && selectedDates[0] > fechaFin) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                instance
                            .clear(); // Opcional: limpiar el campo de fecha de inicio
                            }
                        });
            ...
            flatpickr("#fecha_fin", {
                ...
                locale: "es", // Idioma español
                onChange: function(selectedDates, dateStr, instance) {
                    const fechaInicio = document.getElementById("fecha_inicio")._flatpickr
                        .selectedDates[0];
                    if (fechaInicio && selectedDates[0] < fechaInicio) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                instance.clear(); // Opcional: limpiar el campo de fecha de inicio
                            }
                        });
                    }
                }
                ...
                <div class="card">
                    <div class="card-header py-3">
                        <h5 class="mb-0 text-center"><strong>Asientos Contables</strong>
                            @if (in_array('ASIENTOS.CREAR', $permissions ?? []))
