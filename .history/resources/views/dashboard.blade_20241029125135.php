...
@section('script')
    <script>
        $(document).ready(function(){
            $.ajax({
                url: "{{ route('asientos.totalAsientos') }}",
                type: "POST",
                headers: {
                ...
                success: function(response) {
                    ...
                    $("#h3asientos").html(response.totalAsientos);
            ...
            $.ajax({
                url: "{{ route('asientos.totalCuentas') }}",
                type: "POST",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') // Token CSRF para protección
                },
                success: function(response) {
                    //console.log(response);
                    $("#h3cuentas").html(response.totalCuentas);
